...
//        var_dump($this->paginate('Compoundpfr_data', $search));
     ...
     * the uploading and preview is already done all this does is add the colum to the data base that have being matched to a column in the table to the table
     */
