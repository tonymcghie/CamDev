...
trait Overviewable {
    ...
    public function overview(){
        ...
        if (!empty($this->request->query)) {
            ...
            //$this->set('column', $for);  //this is not working and needs to be set from $this->request->query
