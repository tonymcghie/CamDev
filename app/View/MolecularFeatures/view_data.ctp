...
?>
<header>
<h1>Molecular Features Data Viewer</h1>
</header>
<table class="noFormat viewSampleSet">
    <tr>
        ...
        <td><h2>Instrument:</h2> <?php echo $info['Molecular_feature']['ms_instrument_loc']; ?></td>
    </tr>
    <tr>
        <td><h2>Retention time:</h2> <?php echo $info['Molecular_feature']['retention_time']; ?></td>
        <td><h2>Exact Mass:</h2> <?php echo $info['Molecular_feature']['mz']; ?></td>
    ...
    <tr>
        ...
        <td><h2>Sample Description:</h2> <?php echo $info['Molecular_feature']['sample_description']; ?></td>
    </tr>
    <tr>
