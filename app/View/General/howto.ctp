...
<ul class="nav nav-tabs">
    <li id="AccessSampleSetDataTab" class="currentTab" onclick="swap('AccessSampleSetData')"><a href="#">Access Sample Set Data</a></li> <!-- sets this to start as the current tab -->
    <li id="pfrDataSearchTab" onclick="swap('pfrDataSearch')"><a href="#">Search PFR Data</a></li>
...
<div id="pfrDataSearch" style="display: none;">
...
<script>
    ...
    ids = ['AccessSampleSetData', 'pfrDataSearch', 'compounds', 'PFRdata', 'metabolites'];
