...
class StringHelper extends AppHelper{
    private $strings = [
        ...
        'Compound_msms_form' => [
            ...
            'edit_title' => 'PFR Chemistry: Compound msms data (add/edit)',
            'edit_sub_title' => 'Enter/Edit the msms information about this compound and then click Save',
            'cas' => 'CAS Number',
            'compound_name' => 'Compound Name',
            'msms_ions' => 'msms Ions',
            'msms_ions_ph' => 'Enter msms ions separated with a semicolon (;)',
            'parent_mz' => 'Parent ion (m/z)',
            'energy_ev' => 'Ionization (eV)',
            'charge' => 'Polarity',
            'msms_level' => 'msms Level',
            'instrument' => 'MS Instrument',
            'instrument_ph' => 'enter the name and type of MS used to acquire the msms data',
            'comment' => 'Additional Info.',
            'comment_ph' => 'eg additional info about msms experiment'],
        'Project_form' => [
            'title' => 'Add Project',
        ...
        'Molecular_feature' => [
            ...
            'chromatography_description' => 'Chromatography',
