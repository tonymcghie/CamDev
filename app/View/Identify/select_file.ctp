...
<p> 1) Generate a .csv file where columns A-F contains accurate masses.</p>
<p> 2) Select your input data file; select a mass tolerance (eg +/- 10 mDa) and the ion type;  select your input data file.</p>
