...
<div id="<?php echo $row['Analysis']['title'];?>pane" name="panes" class='tab-pane fade in active'>
    <div id="slide_1_<?php echo $row['Analysis']['title'];?>pane">
        ...
        <table id="reagentsTable">
            <tr>
                <td><input type="text" placeholder="Compounds" id="Compounds"></td>
                <td><input type="text" placeholder="Molicular Weight" id="Mole_Weight"></td>
                <td><input type="text" placeholder="Concentration" id="Concentration"></td>
                <td><input type="text" placeholder="Volume" id="Volume"></td>
                <td><input type="text" placeholder="Quantity Required" id="Quan_Required"></td>
            </tr>
        </table>
