...
<?= $this->BootstrapForm->single_button([
    'onclick' => 'remove_search_set(this);return false;',
    'class' => 'btn-danger',
    'text' => 'x'
]); ?>
...
<?= $this->BootstrapForm->single_button([
    'onclick' => 'submit_first_form(\'search-results\'); return false;',
    'class' => 'btn-primary col-lg-6',
    'text' => 'Review Data' // TODO use string helper
]); ?>
<?= $this->BootstrapForm->end_group(); ?>
