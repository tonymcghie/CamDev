...
<?= $this->BootstrapForm->input_maker('criteria', ['type' => 'select', 'options' => $by_options, 'div' => ['class' => 'col-lg-3']]); ?>
...
<?= $this->BootstrapForm->input_maker('logic', ['type' => 'select', 'options' => $for_options, 'div' => ['class' => 'col-lg-2']]); ?>
...
<?= $this->BootstrapForm->single_button('Review Data', ['onclick' => 'submit_first_form(\'search-results\'); return false;'], ['class' => 'btn-primary col-lg-1']); ?>
<?= $this->BootstrapForm->end_group(); ?>
