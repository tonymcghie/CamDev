...
//if (isset($results[0]['Sample'])){     
    ...
    $cols = array('sample_name', 'treatment_1', 'description_1', 'treatment_2', 'description_2', 'treatment_3', 'description_3', 'replication', 'sample_weight', 'weight_unit', 'tissue', 'kea_num', 'comment');
    $model = 'Sample';
    $type = 'Sample';
